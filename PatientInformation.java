...
public class PatientInformation extends JPanel{
	...
	private JComboBox<String> genderComboList = new JComboBox<String>(genderList);
	private JComboBox<String> monthComboBox = new JComboBox<String>(monthList);
	...
	public PatientInformation() {
		addDays(dayList);
		addYears(yearList);		
		dayComboBox = new JComboBox<String>(dayList);
